    ...
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre,string id)
        {
            if (_context.Movie == null) {
                return Problem("La lista de películas esta vacia");
            }
            ...
            //Consultamos todas las peliculas en movies con LINQ
            var movies = from m in _context.Movie
                         select m;

            if (!String.IsNullOrEmpty(id)) { 

                //buscamos todas las peliculas que en el titulo contengan la cadena a buscar
